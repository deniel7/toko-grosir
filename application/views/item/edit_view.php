									...
									<div class="col-xs-12">
										<form action="<?php echo base_url(); ?>item/edit_exe" method="post" name="frm_edit_item" id="frm_edit_item" class="form-horizontal" role="form">
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="text" id="txt_code" name="txt_code" class="col-xs-12" readonly value="<?php echo $code; ?>" />
												</div>
												...
												<div class="col-sm-3">
													<input type="text" id="txt_qty" name="txt_capacity" class="col-xs-12 txt_numeric" required value="<?php echo $crt_capacity; ?>" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" id="txt_to" name="txt_to" class="col-xs-12 txt_numeric" required value="<?php echo $to_price; ?>" />
												</div>
											</div>
